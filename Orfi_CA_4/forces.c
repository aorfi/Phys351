...
double QVelo0(double *q, double t, int num_elems){ // dtheta1/dt
    ...
    f /= l_1*l_1*l_2*(M - m_2*cos12*cos12); 
    return f;
}
...
double QVelo1(double *q, double t, int num_elems){ // dtheta2/dt
    ...
    cos12 = cos(theta_1-theta_2); 
    M = m_1+m_2;
    f = l_1*M*p_2-l_2*m_2*p_1*cos12;
    f /= l_1*pow(l_2,2)*m_2*(M-m_2*pow(cos12,2));
    return f;
}
...
double QVelo2(double *q, double t, int num_elems){ // dp1/dt
    ...
    M = m_1+m_2;
    a = -1*p_1*p_2*sin12;
    a /= l_1*l_2*(M-m_2*pow(cos12,2));
    b = (l_2/l_1)*pow(p_1,2)+(l_1/l_2)*(M/m_2)*pow(p_2,2)-2*p_1*p_2*cos12;
    b *= m_2*cos12*sin12;
    b /= l_1*l_2*pow((M-m_2*pow(cos12,2)),2);
    c = -1*M*9.8*l_1*sin(theta_1);
    f = a+b+c;
    return f;
}
...
double TotalEnergy(double *q){
    ...
    a = (l_2/l_1)*pow(p_1,2)+(l_1/l_2)*(M/m_2)*pow(p_2,2)-2*p_1*p_2*cos12;
    a /= 2*l_1*l_2*(M-m_2*pow(cos12,2));
    b = -1*M*9.8*l_1*cos(theta_1)-m_2*9.8*l_2*cos(theta_2);
    E=a+b;
    return E;
}