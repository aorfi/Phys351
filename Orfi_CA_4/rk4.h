...
double AdaptiveRK4Step(double *q, double *q_next, FuncPt *QVelos, double t_now, double *t_next,double h, int num_eq);
double EstimateError(double *q_full, double *q_next, double t_now, double h, int num_eq);
